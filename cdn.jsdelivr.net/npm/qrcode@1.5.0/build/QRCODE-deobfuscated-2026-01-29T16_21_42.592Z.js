  ...
  var w = o,
    ...
    E = h(function (t, r) {
      ...
      r.getBestMask = function (t, e) {
        for (
          var n = Object.keys(r.Patterns).length, o = 0, a = 1e400, i = 0;
          i < n;
          i++
        ) {
          e(i)
  ...
  function ot(t, r, e) {
    ...
    for (n = 0; n < 15; n++) {
      ...
      n < 6
        ...
        : n < 8
        ? t.set(n + 1, 8, o, true)
        : t.set(a - 15 + n, 8, o, true)
      n < 8
        ? t.set(8, a - n - 1, o, true)
        : n < 9
        ? t.set(8, 15 - n - 1 + 1, o, true)
        : t.set(8, 15 - n - 1, o, true)
    }
    t.set(a - 8, 8, 1, true)
  }
  function at(t, r, e) {
            ...
            if (!(a + u <= -1 || e <= a + u)) {
              for (var s = -1; s <= 7; s++) {
                i + s <= -1 ||
                  ...
                  (s >= 0 && s <= 6 && (0 === u || 6 === u)) ||
                  (u >= 2 && u <= 4 && s >= 2 && s <= 4)
                    ? t.set(a + u, i + s, true, true)
                    : t.set(a + u, i + s, false, true))
              }
            }
          }
        }
        ...
        for (var e = p.getPositions(r), n = 0; n < e.length; n++) {
          for (var o = e[n][0], a = e[n][1], i = -2; i <= 2; i++) {
            for (var u = -2; u <= 2; u++) {
              ...
              2 === u ||
              (0 === i && 0 === u)
                ? t.set(o + i, a + u, true, true)
                : t.set(o + i, a + u, false, true)
            }
          }
        }
      })(c, r),
  ...
  var gt = function (t, r, e) {
    var n = st.getOptions(r),
      ...
      s =
        ...
        ' d="' +
        (function (t, r, e) {
          for (var n = '', o = 0, a = false, i = 0, u = 0; u < t.length; u++) {
